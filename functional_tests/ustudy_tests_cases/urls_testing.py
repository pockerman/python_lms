...
#testing courses catalog URLs
	def test_can_access_catalog_page(self):
		"""
			Test: John can access the courses catalog page
		"""
		self.page_title_is('/courses/catalog/','Ustudy Courses Catalog')

	#def test_can_access_subject_catalog_page(self):
	#	"""
	#		Test: John can access the catalog page for a given subject
	#	"""
		#Subject.objects.create(title="Subject"+str(s),slug="subject-"+str(s)).save()
		
	#	self.page_title_is('/courses/catalog/subject/test-subject/','Ustudy Courses Catalog')
